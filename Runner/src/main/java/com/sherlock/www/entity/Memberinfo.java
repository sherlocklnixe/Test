...
public class Memberinfo implements java.io.Serializable {
	...
	public Memberinfo(String nickname, String password, Long point, Date latestdate, int gradeid) {
		super();
	...
	public Memberinfo(Long id, String nickname, Long point) {
		super();
		this.id = id;
		this.nickname = nickname;
		this.point = point;
	...
	public Memberinfo(String nickname,String passwordquestion,String passwordanswer){
		this.nickname = nickname;
		this.passwordquestion = passwordquestion;
		this.passwordanswer = passwordanswer;
	}
	
	public Memberinfo(String nickname,String password){
		this.nickname = nickname;
		this.password = password;
	}
	...
	/*@ManyToOne(targetEntity=Graderecord.class)
	...
	public String toString() {
		return "Memberinfo [id=" + id + ", graderecord=" + graderecord + ", nickname=" + nickname + ", password="
				+ password + ", passwdre=" + passwdre + ", gender=" + gender + ", age=" + age + ", email=" + email
				+ ", provincecity=" + provincecity + ", address=" + address + ", phone=" + phone + ", passwordquestion="
				+ passwordquestion + ", passwordanswer=" + passwordanswer + ", recommender=" + recommender + ", point="
				+ point + ", registerdate=" + registerdate + ", latestdate=" + latestdate + ", status=" + status
				+ ", isonline=" + isonline + ", memberSpace=" + memberSpace + ", gradeid=" + gradeid + "]";
	}

	public Memberinfo(Long id, String nickname, String gender, Long age, String provincecity, Long point) {
		super();
		this.id = id;
		this.nickname = nickname;
		this.gender = gender;
