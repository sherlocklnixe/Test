...
<script type="text/javascript">
		...
		function addFriend(){
			document.forms.buddyListForm.action="matchFriend1.action?nickname=${nickname}";
...
<div id="main">
  ...
  <div id="tabs1">
  <ul>
    <li><a href="matchFriend1.action?nickname=${nickname}" title="好友速配"><span>好友速配</span></a></li>
    <li><a href="buddyList1.action?nickname=${nickname}" title="好友名单"><span><b>好友名单</b></span></a></li>
				...
				<tr>
					<td colspan="2" width="100%">
						<table width="100%">
							...
							<tbody>	
							<c:forEach items = "${friend}" var = "item"  varStatus="status">
						        <tr>
								<th width="10%" align="center">
									<input type="checkbox" name="nickName" value="${item.getNickname()}" />
								</th>
								<td width="20%" align="center">
									${item.getNickname()}
								</td>
								<td width="20%" align="center">${item.getGender()}</td>
								<td width="20%" align="center" >${item.getAge()}</td>
								<td width="20%" align="center">${item.getAddress()}</td>
								<td width="10%" align="center">
									<img src="images/button_delete.gif" alt="移动到黑名单" onclick="window.location='moveToBlack1.action?blackName=${item.getNickname()}&&nickname=${nickname}'" style="cursor:hand"/>
								</td>
							</tr>
							 </c:forEach> 
							</tbody>						
