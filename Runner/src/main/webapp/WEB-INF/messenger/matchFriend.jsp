...
<div id="main">
  ...
  <div id="tabs1">
  <ul>
    <li><a href="matchFriend1.action?nickname=${nickname}" title="好友速配"><span><b>好友速配</b></span></a></li>
    <li><a href="buddyList1.action?nickname=${nickname}" title="好友名单"><span>好友名单</span></a></li>
    <li><a href="blackList1.action?nickname=${nickname}" title="黑名单"><span>黑名单</span></a></li>
  </ul>
</div>
<br /><br />
	 ...
	 <br /><br />
		<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<tbody>
				<tr>
					<td width="100%">
						<form action="matchFriend2.action?nickname=${nickname}" method="post" name="matchFriend">
							...
							<tr>
         						 <td align="center">年龄范围：
         						 	<select name="age">
                  						...
                  						<option value="null" selected="selected">不限</option>
                    				</select>
                    			</td>
           						<td align="center">性别：
                					<select name="gender">
                				...
                				<td align="center">所在省/城市：
                					<select name="provinceCity">
									  ...
									  value=32>港澳台</OPTION> <OPTION value=33>海外</OPTION> 
                    					<option selected="selected" value="null">不限</option>
                    				</select> 
                    			</td>
                    			<td align="center">
			...
			<table width="100%" cellspacing="1" cellpadding="3" align="center">
				<tfoot>
				<c:forEach items = "${matchFriend}" var = "item"  varStatus="status">
				<tr height="25">
					<td width="15%" align="center">${item.getNickname()}</td>
					<td width="15%" align="center">${item.getGender()}</td>
					<td width="15%" align="center">${item.getAge()}</td>
					<td width="15%" align="center">${item.getAddress()}</td>
					<td width="20%" align="center">
						<a href="addFriend1.action?nickname=${nickname}&&friendname=${item.getNickname()}">添加好友</a>
					</td>
					<td width="20%" align="center">
						<a href="#">发送短信</a>
					</td>
