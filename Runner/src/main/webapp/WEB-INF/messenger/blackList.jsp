...
<div id="main">
  ...
  <ul>
    ...
    <li><a href="blackList1.action?nickname=${nickname}"" title="黑名单"><span><b>黑名单</b></span></a></li>
  </ul>
</div>
<br /><br />
				...
				<tr>
					<td colspan="2" width="100%">
						<table width="100%">
							...
							<tbody>								
							<c:forEach items = "${black}" var = "item"  varStatus="status">
						        <tr>
								<th width="10%" align="center">
								...
								<td width="10%" align="center">
									<img src="images/button_delete.gif" alt="移动到黑名单" onclick="window.location='pages/messenger/moveToBlackList.do?${item.getNickname()}'" style="cursor:hand"/>
								</td>
							</tr>
							 </c:forEach> 														
							</tbody>						
