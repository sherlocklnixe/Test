...
<script src="js/common.js" type="text/javascript"></script>
		...
		<script type="text/javascript">
			function delMessage(){
				...
				document.forms.inboxForm.action="delReceiveMessage.action?nickname=${nickname}";
			...
			function detailMessage(){
				...
				document.forms.inboxForm.action="detailMessage.action?nickname=${nickname}";
				document.forms.inboxForm.submit();		
			}
		</script>
</head>
...
<div id="main">
  ...
  <div id="tabs1">
  <ul>
    <li><a href="sendInfo1.action?nickname=${nickname}" title="写纸条"><span>写纸条</span></a></li>
    <li><a href="inbox1.action?nickname=${nickname}" title="收件箱"><span><b>收件箱</b></span></a></li>
    <li><a href="outbox1.action?nickname=${nickname}" title="发件箱"><span>发件箱</span></a></li>
  </ul>
</div>
<br /><br />
				...
				<tr>
					<td width="100%" colspan="2">
						<table width="100%">
							...
							<tbody>
								<c:forEach items="${listSendMessage}" var="item" varStatus="status">
								<tr>
									<td width="10%">
										<input type="checkbox" name="ID" value="${item.getId()}"/>
									</td>
									<td width="20%">
										<a href="detailMessage.action?nickname=${nickname}&&ID=${item.getId()}">${item.getTitle()}</a>
									</td>
									<td width="20%">${item.getSender()}</td>
									<td width="30%">
										${item.getSenddate()}
									</td>
									<td>
