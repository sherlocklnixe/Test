			...
			<table width="500" border="0" style="margin-top:20px;" align="center" cellpadding="0" cellspacing="0">
				...
				<tbody>
					<tr>
						...
						<td>${findMessage.getSender()}</td>
					</tr>
					<tr>
						<th>主题</th>
						<td>${findMessage.getTitle()}</td>
					</tr>
					<tr>
						<th>消息内容</th>
						<td>${findMessage.getContent()}</td>
					</tr>
				...
				<tfoot>
					<tr>
						<th colspan="2" align="center" classo="line4" style="text-align:center">
							<input type="button" value="返回" onclick="self.location='inbox1.action?nickname=${nickname}'" />
						</th>
					</tr>
				</tfoot>
			</table>
