     ...
     <div id="center">
		...
		<table width="600">
			<thead>
  			...
  			<tr>
				<td width="100%">
					<form action="modify1.action?nickname=${nickname}" method="post" onSubmit="return validateModifyForm(this);">
					...
					<tr>
						...
						<td width="30%" >
							<input type="text" maxLength="14" style="width:200px" name="nickName" disabled  value="${nickname}"/>
						</td>
					</tr>
					<tr>
						<th class="line1">
